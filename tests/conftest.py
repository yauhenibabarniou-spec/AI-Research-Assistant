...
def sample_documents():
    ...
    return [
        Document(
            page_content="ChromaDB is a vector database for embeddings",
            metadata={"source": "chromadb.txt", "start_index": 0},
        ),
        Document(
            page_content="FastAPI is a modern web framework for Python",
            metadata={"source": "fastapi.txt", "start_index": 100},
        ),
        Document(
            page_content="LangChain is a framework for building LLM applications",
            metadata={"source": "langchain.txt", "start_index": 200},
        ),
        Document(
            page_content="Python is a programming language", metadata={"source": "python.txt", "start_index": 300}
        ),
    ]
