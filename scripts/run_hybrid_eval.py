...
def main() -> None:
    ...
    parser.add_argument("--output", default="eval/reports/hybrid_report.csv")
    parser.add_argument("--search-type", type=str, default="weighted")
    ...
    # Create hybrid store with specified search type
